...
public abstract class ShapeBuilder {
    ...
    protected void begin(RenderMethod renderMethod) {
        this.bufferBuilder = Tessellator.getInstance().begin(renderMethod.mode(), renderMethod.format());
    }
    ...
    public void putVertex(Vector3f v, float r, float g, float b, float a) {
        this.bufferBuilder.vertex(positionMatrix, v.x, v.y, v.z).color(r, g, b, a);
    }
