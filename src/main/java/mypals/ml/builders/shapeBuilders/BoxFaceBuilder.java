...
public class BoxFaceBuilder extends BaseBuilder<BoxFaceBuilder, BoxLikeShape.BoxTransformer> implements BoxBuilder<BoxFaceBuilder> {
    ...
    @Override public BoxFaceBuilder min(Vec3 min) { this.min = min; return this; }
    @Override public BoxFaceBuilder max(Vec3 max) { this.max = max; return this; }
    @Override public BoxFaceBuilder aabb(Vec3 min, Vec3 max) { this.min = min; this.max = max; return this; }
    @Override public BoxFaceBuilder size(Vec3 size) { this.dim = size; return this; }
