...
public class ConeBuilder extends BaseBuilder<ConeBuilder, CylinderShape.CylinderTransformer> {
    ...
    public ConeBuilder axis(CircleLikeShape.CircleAxis circleAxis) { this.circleAxis = circleAxis; return this; }
    public ConeBuilder segments(int segments) { this.segments = segments; return this; }
    public ConeBuilder radius(float radius) { this.radius = radius; return this; }
