...
public class FaceCircleBuilder extends BaseBuilder<FaceCircleBuilder,FaceCircleShape.FaceCircleTransformer> {
    ...
    public FaceCircleBuilder axis(CircleLikeShape.CircleAxis circleAxis) { this.circleAxis = circleAxis; return this; }
    public FaceCircleBuilder segments(int segments) { this.segments = segments; return this; }
